...
package ch.upte.modular_permission_location
...
class ModularPermissionLocationPlugin : FlutterPlugin, MethodCallHandler, ActivityAware,
  ...
  override fun onAttachedToEngine(binding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(binding.binaryMessenger, "ch.upte.modularPermissionsLocation")
  ...
  private fun requestPermission(
    ...
    val prefs = activity.getSharedPreferences("ch.upte.modular.permissions.$permission", Context.MODE_PRIVATE)
